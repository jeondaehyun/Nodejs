...
let db;
MongoClient.connect('mongodb+srv://admin:eogus680201@cluster0.xemubja.mongodb.net/?retryWrites=true&w=majority', function(error, client){
...
app.post('/add' , function(req, res) { 
    ...
    db.collection('counter').findOne({name : '게시물갯수'}, function(error, result) { 
        ...
        db.collection('post').insertOne({ _id : totalPostingCount+1, title : req.body.title , date : req.body.date}, function(error,result) {
            console.log('저장완료'); 
        })
